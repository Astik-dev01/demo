...
INSERT INTO time_entries (id, task_id, user_id, hours, description, logged_date, created_at) VALUES
    ('00000008-0000-0000-0000-000000000001', '01000001-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 8, 'Настройка Docker и docker-compose', NOW() - INTERVAL '56 days', NOW() - INTERVAL '56 days'),
    ('00000008-0000-0000-0000-000000000002', '01000001-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 6, 'Настройка GitHub Actions', NOW() - INTERVAL '55 days', NOW() - INTERVAL '55 days'),
    ('00000008-0000-0000-0000-000000000003', '01000001-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 4, 'Тестирование деплоя на staging', NOW() - INTERVAL '53 days', NOW() - INTERVAL '53 days'),
    ('00000008-0000-0000-0000-000000000004', '01000001-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003', 8, 'Проектирование схемы БД', NOW() - INTERVAL '54 days', NOW() - INTERVAL '54 days'),
    ('00000008-0000-0000-0000-000000000005', '01000001-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003', 8, 'Создание миграций', NOW() - INTERVAL '53 days', NOW() - INTERVAL '53 days'),
    ('00000008-0000-0000-0000-000000000006', '01000001-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003', 6, 'Оптимизация индексов', NOW() - INTERVAL '51 days', NOW() - INTERVAL '51 days'),
    ('00000008-0000-0000-0000-000000000007', '01000001-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003', 6, 'Документация ERD', NOW() - INTERVAL '50 days', NOW() - INTERVAL '50 days'),
    ('00000008-0000-0000-0000-000000000008', '01000001-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003', 8, 'Базовая JWT аутентификация', NOW() - INTERVAL '48 days', NOW() - INTERVAL '48 days'),
    ('00000008-0000-0000-0000-000000000009', '01000001-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003', 8, 'Refresh токены', NOW() - INTERVAL '46 days', NOW() - INTERVAL '46 days'),
    ('00000008-0000-0000-0000-000000000010', '01000001-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003', 8, 'OAuth2 интеграция', NOW() - INTERVAL '44 days', NOW() - INTERVAL '44 days'),
    ('00000008-0000-0000-0000-000000000011', '01000001-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000003', 8, 'Исследование Stripe API', NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days'),
    ('00000008-0000-0000-0000-000000000012', '01000001-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000003', 7, 'Базовая интеграция', NOW() - INTERVAL '6 days', NOW() - INTERVAL '6 days'),
    ('00000008-0000-0000-0000-000000000013', '01000001-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000006', 8, 'Верстка карточек товаров', NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days'),
    ('00000008-0000-0000-0000-000000000014', '01000001-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000006', 6, 'Фильтры и сортировка', NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days'),
    ('00000008-0000-0000-0000-000000000015', '01000001-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000006', 4, 'Адаптивная верстка', NOW() - INTERVAL '6 days', NOW() - INTERVAL '6 days')
ON CONFLICT DO NOTHING;
