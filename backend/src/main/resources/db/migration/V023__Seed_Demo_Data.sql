...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at, completed_at)
SELECT
    't1000000-0000-0000-0000-000000000002'::uuid,
    'c1000000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
    'e1000000-0000-0000-0000-000000000005',
    2,
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at, completed_at)
SELECT
    't1000000-0000-0000-0000-000000000003'::uuid,
    'c1000000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
    'e1000000-0000-0000-0000-000000000005',
    3,
...
SELECT
    't1000000-0000-0000-0000-000000000004'::uuid,
    'c1000000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000005'::uuid,
    'c1000000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000006'::uuid,
    'c1000000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000007'::uuid,
    'c1000000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
    'e1000000-0000-0000-0000-000000000002',
    7,
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000008'::uuid,
    'c1000000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000009'::uuid,
    'c1000000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
    'e1000000-0000-0000-0000-000000000001',
    9,
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000010'::uuid,
    'c1000000-0000-0000-0000-000000000001',
    'd1000000-0000-0000-0000-000000000001',
    'e1000000-0000-0000-0000-000000000001',
    10,
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at, completed_at)
SELECT
    't1000000-0000-0000-0000-000000000011'::uuid,
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000012'::uuid,
    'c1000000-0000-0000-0000-000000000002',
    'd1000000-0000-0000-0000-000000000003',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000013'::uuid,
    'c1000000-0000-0000-0000-000000000002',
    'd1000000-0000-0000-0000-000000000003',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000014'::uuid,
    'c1000000-0000-0000-0000-000000000002',
    'd1000000-0000-0000-0000-000000000003',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000015'::uuid,
    'c1000000-0000-0000-0000-000000000002',
    'd1000000-0000-0000-0000-000000000003',
    'e1000000-0000-0000-0000-000000000006',
    5,
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at, completed_at)
SELECT
    't1000000-0000-0000-0000-000000000016'::uuid,
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000017'::uuid,
    'c1000000-0000-0000-0000-000000000003',
    'd1000000-0000-0000-0000-000000000004',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000018'::uuid,
    'c1000000-0000-0000-0000-000000000003',
    'd1000000-0000-0000-0000-000000000004',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000019'::uuid,
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000020'::uuid,
    'c1000000-0000-0000-0000-000000000004',
    'd1000000-0000-0000-0000-000000000005',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at, completed_at)
SELECT
    't1000000-0000-0000-0000-000000000021'::uuid,
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000022'::uuid,
    'c1000000-0000-0000-0000-000000000005',
    'd1000000-0000-0000-0000-000000000006',
...
INSERT INTO tasks (id, project_id, board_id, column_id, number, title, description, reporter_id, assignee_id, priority_id, status_id, position, due_date, estimated_hours, spent_hours, created_at)
SELECT
    't1000000-0000-0000-0000-000000000023'::uuid,
    'c1000000-0000-0000-0000-000000000005',
    'd1000000-0000-0000-0000-000000000006',
...
INSERT INTO task_comments (id, task_id, user_id, content, created_at) VALUES
    ('g1000000-0000-0000-0000-000000000001', 't1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000001', 'Какой платёжный провайдер используем? Stripe или PayPal?', NOW() - INTERVAL '8 days'),
    ('g1000000-0000-0000-0000-000000000002', 't1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000003', 'Думаю лучше начать со Stripe - у них проще интеграция и лучше документация', NOW() - INTERVAL '8 days' + INTERVAL '2 hours'),
    ('g1000000-0000-0000-0000-000000000003', 't1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000001', 'Согласен, начнём со Stripe. Потом добавим PayPal как альтернативу', NOW() - INTERVAL '7 days'),
    ('g1000000-0000-0000-0000-000000000004', 't1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000002', 'Макеты готовы в Figma, ссылка в описании задачи', NOW() - INTERVAL '10 days'),
    ('g1000000-0000-0000-0000-000000000005', 't1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000006', 'Спасибо! Начала работу над версткой', NOW() - INTERVAL '9 days'),
    ('g1000000-0000-0000-0000-000000000006', 't1000000-0000-0000-0000-000000000012', 'a1000000-0000-0000-0000-000000000002', 'Не забудьте про лимиты на переводы - нужно согласовать с безопасностью', NOW() - INTERVAL '15 days'),
    ('g1000000-0000-0000-0000-000000000007', 't1000000-0000-0000-0000-000000000012', 'a1000000-0000-0000-0000-000000000007', 'Уже связался с отделом безопасности, ждём требования', NOW() - INTERVAL '14 days'),
    ('g1000000-0000-0000-0000-000000000008', 't1000000-0000-0000-0000-000000000013', 'a1000000-0000-0000-0000-000000000006', 'Какой сервис используем для push - Firebase?', NOW() - INTERVAL '8 days'),
    ('g1000000-0000-0000-0000-000000000009', 't1000000-0000-0000-0000-000000000013', 'a1000000-0000-0000-0000-000000000002', 'Да, Firebase Cloud Messaging для обеих платформ', NOW() - INTERVAL '7 days'),
    ('g1000000-0000-0000-0000-000000000010', 't1000000-0000-0000-0000-000000000017', 'a1000000-0000-0000-0000-000000000003', 'Нужно учесть разные типы отпусков: ежегодный, учебный, без сохранения ЗП', NOW() - INTERVAL '12 days'),
    ('g1000000-0000-0000-0000-000000000011', 't1000000-0000-0000-0000-000000000017', 'a1000000-0000-0000-0000-000000000001', 'Да, и не забудьте про больничные', NOW() - INTERVAL '11 days'),
    ('g1000000-0000-0000-0000-000000000012', 't1000000-0000-0000-0000-000000000019', 'a1000000-0000-0000-0000-000000000003', 'Воронка должна быть настраиваемой - разные команды используют разные этапы', NOW() - INTERVAL '10 days'),
    ('g1000000-0000-0000-0000-000000000013', 't1000000-0000-0000-0000-000000000022', 'a1000000-0000-0000-0000-000000000005', 'Grafana дашборды готовы для backend сервисов, осталось frontend', NOW() - INTERVAL '5 days'),
    ('g1000000-0000-0000-0000-000000000014', 't1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000004', 'Провела тестирование API каталога - нашла несколько багов, создала тикеты', NOW() - INTERVAL '3 days'),
    ('g1000000-0000-0000-0000-000000000015', 't1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000008', 'Code review завершён, есть пара замечаний по оптимизации запросов', NOW() - INTERVAL '2 days')
ON CONFLICT DO NOTHING;
...
INSERT INTO task_tags (task_id, tag_id, created_at) VALUES
    ('t1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000002', NOW() - INTERVAL '55 days'),
    ('t1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000002', NOW() - INTERVAL '54 days'),
    ('t1000000-0000-0000-0000-000000000003', 'f1000000-0000-0000-0000-000000000002', NOW() - INTERVAL '48 days'),
    ('t1000000-0000-0000-0000-000000000004', 'f1000000-0000-0000-0000-000000000002', NOW() - INTERVAL '18 days'),
    ('t1000000-0000-0000-0000-000000000005', 'f1000000-0000-0000-0000-000000000002', NOW() - INTERVAL '13 days'),
    ('t1000000-0000-0000-0000-000000000006', 'f1000000-0000-0000-0000-000000000004', NOW() - INTERVAL '8 days'),
    ('t1000000-0000-0000-0000-000000000007', 'f1000000-0000-0000-0000-000000000003', NOW() - INTERVAL '10 days'),
    ('t1000000-0000-0000-0000-000000000011', 'f1000000-0000-0000-0000-000000000006', NOW() - INTERVAL '48 days'),
    ('t1000000-0000-0000-0000-000000000012', 'f1000000-0000-0000-0000-000000000006', NOW() - INTERVAL '18 days'),
    ('t1000000-0000-0000-0000-000000000013', 'f1000000-0000-0000-0000-000000000008', NOW() - INTERVAL '8 days')
ON CONFLICT DO NOTHING;

-- =====================================================
-- TIME ENTRIES (for completed and in-progress tasks)
-- =====================================================
INSERT INTO time_entries (id, task_id, user_id, hours, description, logged_date, created_at) VALUES
    ('h1000000-0000-0000-0000-000000000001', 't1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 8, 'Настройка Docker и docker-compose', NOW() - INTERVAL '56 days', NOW() - INTERVAL '56 days'),
    ('h1000000-0000-0000-0000-000000000002', 't1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 6, 'Настройка GitHub Actions', NOW() - INTERVAL '55 days', NOW() - INTERVAL '55 days'),
    ('h1000000-0000-0000-0000-000000000003', 't1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 4, 'Тестирование деплоя на staging', NOW() - INTERVAL '53 days', NOW() - INTERVAL '53 days'),
    ('h1000000-0000-0000-0000-000000000004', 't1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003', 8, 'Проектирование схемы БД', NOW() - INTERVAL '54 days', NOW() - INTERVAL '54 days'),
    ('h1000000-0000-0000-0000-000000000005', 't1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003', 8, 'Создание миграций', NOW() - INTERVAL '53 days', NOW() - INTERVAL '53 days'),
    ('h1000000-0000-0000-0000-000000000006', 't1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003', 6, 'Оптимизация индексов', NOW() - INTERVAL '51 days', NOW() - INTERVAL '51 days'),
    ('h1000000-0000-0000-0000-000000000007', 't1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003', 6, 'Документация ERD', NOW() - INTERVAL '50 days', NOW() - INTERVAL '50 days'),
    ('h1000000-0000-0000-0000-000000000008', 't1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003', 8, 'Базовая JWT аутентификация', NOW() - INTERVAL '48 days', NOW() - INTERVAL '48 days'),
    ('h1000000-0000-0000-0000-000000000009', 't1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003', 8, 'Refresh токены', NOW() - INTERVAL '46 days', NOW() - INTERVAL '46 days'),
    ('h1000000-0000-0000-0000-000000000010', 't1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003', 8, 'OAuth2 интеграция', NOW() - INTERVAL '44 days', NOW() - INTERVAL '44 days'),
    ('h1000000-0000-0000-0000-000000000011', 't1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000003', 8, 'Исследование Stripe API', NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days'),
    ('h1000000-0000-0000-0000-000000000012', 't1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000003', 7, 'Базовая интеграция', NOW() - INTERVAL '6 days', NOW() - INTERVAL '6 days'),
    ('h1000000-0000-0000-0000-000000000013', 't1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000006', 8, 'Верстка карточек товаров', NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days'),
    ('h1000000-0000-0000-0000-000000000014', 't1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000006', 6, 'Фильтры и сортировка', NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days'),
    ('h1000000-0000-0000-0000-000000000015', 't1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000006', 4, 'Адаптивная верстка', NOW() - INTERVAL '6 days', NOW() - INTERVAL '6 days')
ON CONFLICT DO NOTHING;
